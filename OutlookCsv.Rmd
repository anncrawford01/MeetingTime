...
meetingx <-       select(meeting, Subject, StartDateTime , EndDateTime , Location, Show.time.as , All.day.event,                                     Private)   %>% 
          mutate( meetingtime = difftime(EndDateTime, StartDateTime, units = "mins" ) ) 

##  meetingy <-     mutate(meetingx, meetingtime = difftime(EndDateTime, StartDateTime, units = "mins" ) ) 
